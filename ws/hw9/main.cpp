...
int main(int argc, char** argv) {
    ...
    // int select = 0;
    // KinodynamicProblem2D prob = problems[2];
    ...
    HW9::grade<MyKinoRRT, MySingleIntegrator, MyFirstOrderUnicycle, MySecondOrderUnicycle, MySimpleCar>("stephen.gillet@colorado.edu", argc, argv, std::make_tuple(), std::make_tuple(), std::make_tuple(), std::make_tuple(), std::make_tuple());
    return 0;
}